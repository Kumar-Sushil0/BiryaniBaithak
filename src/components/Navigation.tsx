    ...
    <div className="container mx-auto px-12 md:px-20 lg:px-32 py-6 relative z-10">
      <nav className="bg-[#333333] rounded-full shadow-lg shadow-black/20 px-12 md:px-16 py-3 flex justify-between items-center transition-colors duration-300 border border-[#E8D595]/20">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link
            className={`font-medium transition-colors tracking-wide text-sm ${
              pathname === "/" ? "text-[#E8D595] font-bold" : "text-[#F2F2F2] hover:text-[#E8D595]"
            }`}
            href="/"
          >
            Home
          ...
          <Link
            className={`font-medium transition-colors tracking-wide text-sm ${
              pathname === "/menu" ? "text-[#E8D595] font-bold" : "text-[#F2F2F2] hover:text-[#E8D595]"
            }`}
            href="/menu"
          >
            Menu
          ...
          <Link
            className={`font-medium transition-colors tracking-wide text-sm ${
              pathname === "/cart" ? "text-[#E8D595] font-bold" : "text-[#F2F2F2] hover:text-[#E8D595]"
            }`}
            href="/cart"
          >
            Cart
