            ...
            <div className="bg-[#333333] rounded-2xl p-6 border border-white/10 shadow-lg">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                  ...
                  <div className="grow">
                    ...
                    <div className="text-sm font-bold text-white mb-2">₹320</div>
                    <div className="flex items-center gap-3">
                      <button className="w-6 h-6 rounded-full border border-[#E8D595]/50 text-[#E8D595] hover:bg-[#E8D595] hover:text-[#272727] flex items-center justify-center transition-colors">
                        <span className="material-icons text-sm">remove</span>
                      </button>
                      <span className="text-white font-bold w-4 text-center">1</span>
                      <button className="w-6 h-6 rounded-full border border-[#E8D595]/50 text-[#E8D595] hover:bg-[#E8D595] hover:text-[#272727] flex items-center justify-center transition-colors">
                ...
                <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                  ...
                  <div className="grow">
                    ...
                    <div className="text-sm font-bold text-white mb-2">₹280</div>
                    <div className="flex items-center gap-3">
                      <button className="w-6 h-6 rounded-full border border-[#E8D595]/50 text-[#E8D595] hover:bg-[#E8D595] hover:text-[#272727] flex items-center justify-center transition-colors">
                        <span className="material-icons text-sm">remove</span>
                      </button>
              ...
              <div className="mt-6 pt-4 space-y-3">
                ...
                <div className="flex justify-between text-xl font-[family-name:var(--font-display)] font-bold pt-4 border-t border-white/10 mt-4">
                  ...
                  <span className="text-[#E8D595]">₹630</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex flex-col items-center gap-6">
                    <div className="text-center space-y-2">
                      ...
                      <div className="p-4 bg-white rounded-xl shadow-lg inline-block">
                        ...
                        <div className="mt-2 text-center font-bold text-[#272727] text-lg">₹630</div>
                      </div>
                ...
                <div className="bg-[#272727]/30 border border-dashed border-[#E8D595]/30 rounded-xl p-4 mt-6">
                  ...
                  <ul className="space-y-2 text-xs text-gray-400">
                    ...
                    <li className="flex gap-2">
                      ...
                      <span>
                        Complete payment of <strong>₹630</strong>.
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="bg-[#E8D595] text-[#272727] rounded-full w-4 h-4 flex items-center justify-center font-bold shrink-0">
